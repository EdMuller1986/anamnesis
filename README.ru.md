...
**Статус**: ⚠️ dev-прототип на Cloudflare (Workers + D1 + B2). **Не production-ready** — идёт P0 hardening (изоляция пациентов, auth, upload, backup/restore). Не использовать с реальными медданными (см. `TODO.md`).
