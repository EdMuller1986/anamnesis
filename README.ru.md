...
**Статус**: ⚠️ усиленный форк на Cloudflare (Workers + D1 + B2). Базовые P0 (auth, изоляция, upload, backup/restore с WIPE, миграции D1, audit triggers) сделаны и покрыты тестами; всё равно проверьте restore на *своих* данных перед продакшеном. Исходный аудит — в `TODO.md`.
